    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 bg-[#141414] z-40 flex flex-col justify-center items-center text-[#E6E5E1] overflow-y-auto"
        >
          <div className="flex flex-col gap-0 text-center py-20">
                  ...
                  {item.submenu ? (
                    <div>
                      <button
                        ...
                        className="flex items-center justify-center gap-3 text-[12vw] md:text-[8vw] font-serif italic leading-[0.85] hover:text-white/50 transition-colors cursor-pointer interactive mx-auto"
                      >
                        {item.name}
                        <motion.span
                          className="text-[6vw] md:text-[4vw] opacity-50"
                          animate={{ rotate: openAccordion === item.name ? 90 : 0 }}
                              ...
                              {item.submenu.map((subitem, j) => (
                                ...
                                >
                                  <Link
                                    href={subitem.href}
                                    onClick={toggle}
                                    className="block text-[6vw] md:text-[3vw] font-sans uppercase tracking-[0.1em] opacity-60 hover:opacity-100 transition-opacity py-2"
                                  >
                                    {subitem.name}
                                  </Link>
                                </motion.div>
